Halo. Kita akan memulai tahap pengembangan untuk proyek backend aplikasi keuangan. Sebagai langkah pertama di sesi ini, saya ingin kamu menggunakan kemampuanmu untuk membaca, memahami, dan menjadikan file-file berikut sebagai pedoman mutlak kerjamu:

.agents/core_context.md

.agents/memory.md

.agents/api_specification.md
